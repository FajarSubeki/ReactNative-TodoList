...
import { Body, Header, Title, Container, Content, List, ListItem, InputGroup, Input, Icon, Text, Picker, Button } from 'native-base';
...
class Signup extends Component {
    ...
    render() {
        ...
        return (
                <Container>
                    <Header iosBarStyle={"light-content"} style={styles.headerHead}>
                        <Title style={styles.headerText2}>Register</Title>
                    </Header>
                    {content}
                </Container>
        )
